...
test('can reactivate a product', function () {
    $fake = Stripe::fake([
        'products.update' => StripeFixtures::product([
            'id' => 'prod_123',
            'active' => true,
...
test('create removes id and timestamps from payload', function () {
    $fake = Stripe::fake([
...
test('update removes id and timestamps from payload', function () {
    $fake = Stripe::fake([
