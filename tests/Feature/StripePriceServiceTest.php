...
test('can retrieve a price', function () {
    $fake = Stripe::fake([
...
test('can update a price with allowed fields', function () {
    $fake = Stripe::fake([
...
test('can archive a price', function () {
    $fake = Stripe::fake([
        'prices.update' => StripeFixtures::price([
            'id' => 'price_123',
            'active' => false,
    ...
    expect($fake)->toHaveCalledStripeMethod('prices.update');
});

test('can reactivate a price', function () {
    $fake = Stripe::fake([
        'prices.update' => StripeFixtures::price([
            'id' => 'price_123',
            'active' => true,
...
test('can list prices by product', function () {
    $fake = Stripe::fake([
        'prices.all' => StripeFixtures::priceList([
...
test('can search prices', function () {
    $fake = Stripe::fake([
...
test('can get price by lookup key', function () {
    $fake = Stripe::fake([
        'prices.all' => StripeFixtures::priceList([
...
test('get price by lookup key returns null when not found', function () {
    $fake = Stripe::fake([
        'prices.all' => StripeFixtures::priceList([]),
    ]);
...
test('create removes id and created from payload', function () {
    $fake = Stripe::fake([
