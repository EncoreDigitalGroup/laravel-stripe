...
test('can create StripePrice using make method', function () {
...
test('can create StripePrice from Stripe object with recurring', function () {
...
test('fromStripeObject handles nested product object', function () {
    $stripeObject = \Stripe\Util\Util::convertToStripeObject([
        'id' => 'price_123',
        'object' => 'price',
        'product' => [
...
test('toArray converts recurring enums to values', function () {
    $price = StripePrice::make(
        product: 'prod_123',
        unitAmount: 2000,
        currency: 'usd',
...
test('fromStripeObject handles tiers', function () {
    $stripeObject = \Stripe\Util\Util::convertToStripeObject([
        'id' => 'price_123',
        'object' => 'price',
        'product' => 'prod_123',
...
test('fromStripeObject handles custom unit amount', function () {
    $stripeObject = \Stripe\Util\Util::convertToStripeObject([
        'id' => 'price_123',
        'object' => 'price',
        'product' => 'prod_123',
