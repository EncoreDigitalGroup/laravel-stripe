...
test('can create StripeProduct from Stripe object', function () {
...
test('fromStripeObject handles nested default_price object', function () {
    $stripeObject = Util::convertToStripeObject([
        'id' => 'prod_123',
        'object' => 'product',
        'name' => 'Test Product',
...
test('fromStripeObject handles nested tax_code object', function () {
    $stripeObject = Util::convertToStripeObject([
        'id' => 'prod_123',
        'object' => 'product',
        'name' => 'Test Product',
...
test('can round trip from Stripe object to array', function () {
