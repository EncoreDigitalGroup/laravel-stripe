...
test('can create StripeCustomer using make method', function () {
...
test('can create StripeCustomer from Stripe object', function () {
...
test('fromStripeObject handles missing address', function () {
    $stripeObject = \Stripe\Util\Util::convertToStripeObject([
        'id' => 'cus_123',
        'object' => 'customer',
        'email' => 'test@example.com',
...
test('fromStripeObject handles missing shipping', function () {
    $stripeObject = \Stripe\Util\Util::convertToStripeObject([
        'id' => 'cus_123',
        'object' => 'customer',
        'email' => 'test@example.com',
...
test('toArray returns correct structure with address', function () {
...
test('toArray returns correct structure with shipping', function () {
