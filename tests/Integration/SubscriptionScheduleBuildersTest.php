...
describe('StripeBuilder subscription schedule methods', function () {
    test('provides subscription schedule builder', function () {
    ...
    test('provides subscription schedule phase builder', function () {
        $builder = new StripeBuilder();
...
describe('SubscriptionScheduleBuilder', function () {
    test('builds subscription schedule with all parameters', function () {
        $builder = new StripeBuilder();
    ...
    test('builds subscription schedule with minimal parameters', function () {
        $builder = new StripeBuilder();
...
describe('SubscriptionSchedulePhaseBuilder', function () {
    test('builds subscription schedule phase with all parameters', function () {
        $builder = new StripeBuilder();
        $now = CarbonImmutable::now();
        $endDate = $now->addMonth();
    ...
    test('builds subscription schedule phase with minimal parameters', function () {
        $builder = new StripeBuilder();
...
describe('Stripe facade integration', function () {
    test('provides builder through facade', function () {
    ...
    test('creates complex nested schedule through builders', function () {
        $builder = Stripe::builder();
        $now = CarbonImmutable::now();
